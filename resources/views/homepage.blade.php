            ...
            <div class="row mt--50">
                <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="product__nav nav justify-content-center" role="tablist">
                        <a class="nav-item nav-link" data-toggle="tab" href="#nav-ky-nang" role="tab">Kỹ năng</a>
                        <a class="nav-item nav-link" data-toggle="tab" href="#nav-van-hoc" role="tab">ADVENTURE</a>
                        <a class="nav-item nav-link" data-toggle="tab" href="#nav-tre-em" role="tab">CHILDREN</a>
                        <a class="nav-item nav-link" data-toggle="tab" href="#nav-cook" role="tab">COOK</a>
                    </div>
                </div>
            </div>
            <div class="tab__container mt--60">
                @include('bestSeller.ky_nang')
                @include('bestSeller.van_hoc')
                @include('bestSeller.tre_em')
